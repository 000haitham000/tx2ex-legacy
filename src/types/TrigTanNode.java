 ...
 * @author haitham
 */
public class TrigTanNode extends AbstractNode {

    public TrigTanNode(AbstractNode parent, List<Token> allTokens) {
    ...
    public static NodeRecognizedInfo findLastOccurence(
        ...
        for (int i = targetTokens.size() - 2; i >= 0; i--) {
            ...
            if (!Utils.surrounded(targetTokens.get(i), targetTokens)) {
                ...
                if (targetTokens.get(i).getString().equalsIgnoreCase("tan")
                    ...
                    if (last == -1) {
                        ...
                        throw new InvalidFormatException(
                                targetTokens.get(i),
                                allTtokens,
                                "Un-balanced parentheses, Tan closing bracket ')' is missing.");
                    } else {
                        ...
                        return new NodeRecognizedInfo(
                                i,
                                last,
                                new TrigTanNode(parent, allTtokens),
                                childrenTokensLists);
                    }
                }
            }
    ...
    public String toString() {
        return String.format("tan(%s)", getChild(0).toString());
    }
