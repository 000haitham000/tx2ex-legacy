 ...
 * @author haitham
 */
public class DivisionBinaryOpNode extends AbstractBinaryOpNode {

    public DivisionBinaryOpNode(AbstractNode parent, List<Token> allTokens) {
        super(parent, allTokens);
    }

    public DivisionBinaryOpNode(
                ...
                if (targetTokens.get(i).getString().equals("/")) {
                    ...
                    if (leftChildTokens.isEmpty()) {
                        throw new InvalidFormatException(
                                targetTokens.get(i), 
                                allTtokens, 
                                "Division operator (/) left operand is missing.");
                    }
                    ...
                    if (rightChildTokens.isEmpty()) {
                        throw new InvalidFormatException(
                                targetTokens.get(i), 
                                allTtokens, 
                                "Division operator (/) right operand is missing.");
                    }
                    ...
                    return new NodeRecognizedInfo(
                            i,
                            i,
                            new DivisionBinaryOpNode(parent, allTtokens),
