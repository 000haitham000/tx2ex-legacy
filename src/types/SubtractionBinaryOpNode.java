...
import static types.AdditionBinaryOpNode.findLastOccurence;

/**
 *
 * @author haitham
 */
public class SubtractionBinaryOpNode extends AbstractBinaryOpNode {

    public SubtractionBinaryOpNode(AbstractNode parent, List<Token> allTokens) {
        super(parent, allTokens);
    }

    public SubtractionBinaryOpNode(
                ...
                if (targetTokens.get(i).getString().equals("-")) {
                    ...
                    if (rightChildTokens.isEmpty()) {
                        throw new InvalidFormatException(
                                targetTokens.get(i),
                                allTokens,
                                "Subtraction operator (-) right operand is missing.");
                    }
                    ...
                    return new NodeRecognizedInfo(
                            i,
                            i,
                            new SubtractionBinaryOpNode(parent, allTokens),
                            childrenTokensLists);
                }
            }
        }
