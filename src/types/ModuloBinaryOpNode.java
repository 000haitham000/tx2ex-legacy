 ...
 * @author haitham
 */
public class ModuloBinaryOpNode extends AbstractBinaryOpNode {

    public ModuloBinaryOpNode(AbstractNode parent, List<Token> allTokens) {
        super(parent, allTokens);
    }

    public ModuloBinaryOpNode(
                ...
                if (targetTokens.get(i).getString().equals("%")) {
                    ...
                    if (leftChildTokens.isEmpty()) {
                        throw new InvalidFormatException(
                                targetTokens.get(i), 
                                allTtokens, 
                                "Modulo operator (%) left operand is missing.");
                    }
                    ...
                    if (rightChildTokens.isEmpty()) {
                        throw new InvalidFormatException(
                                targetTokens.get(i), 
                                allTtokens, 
                                "Modulo operator (%) right operand is missing.");
                    }
                    ...
                    return new NodeRecognizedInfo(
                            i,
                            i,
                            new ModuloBinaryOpNode(parent, allTtokens),
